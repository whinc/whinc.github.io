...
[Knex.js](https://github.com/knex/knex) 是一个流行的Node.js SQL查询构建器，它允许你使用JavaScript语言编写SQL查询，而无需直接编写SQL语句。它支持多种数据库，包括MySQL，PostgreSQL，SQLite和Microsoft SQL Server等。使用Knex.js，你可以轻松地构建复杂的SQL查询，包括联接、子查询和聚合函数等。它还提供了一些方便的功能，如事务处理，批量插入和更新等，更多信息参考[Knex.js Guide](https://knexjs.org/guide)
...
使用 Knex.js 前，除了需要安装 knex.js 包自身，还需要额外安装底层数据库驱动，例如下面例子，更多细节参考 [Knex.js Installation](https://knexjs.org/guide/#node-js)
...
更多细节参考[Knex.js Configuration Options](https://knexjs.org/guide/#configuration-options)
...
[示例的 Github 地址](https://github.com/whinc/nodejs-examples/tree/main/knex)
